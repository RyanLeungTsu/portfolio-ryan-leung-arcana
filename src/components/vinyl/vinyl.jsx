    ...
    >
      <div style={{ position: "relative" }}>
        <div className="vinyl-wrapper" style={wrapperStyle}>
          ...
          {/* disc */}
          <div
            className={`vinyl-disc-group${isPlaying ? " vinyl-disc-group--spinning" : ""}`}
          >
            <img
              src={vinylDisc}
              alt=""
          ...
          {isListening && (
            <div className="vinyl-track-info">
              <p className="vinyl-track-title-sub">Currently vibing to</p>
      ...
      {showPopup &&
        (isListening ? (
          <div className="vinyl-listen-popup">
            <p className="vinyl-listen-info">Song Information</p>
          ...
          <div className="vinyl-spotify-popup vinyl-spotify-popup--visible">
            <p className="popup-cta">I'm not currently listening to anything. If i am this widget will invite you to listen along! Checkout my coding playlist in the meantime!</p>
            <iframe
